    ...
    <FormContainer>
      ...
      >
        ...
        <Form onSubmit={submitHandler}>
          <Form.Group controlId="name" className="my-3 mb-3">
          ...
          <Form.Group controlId="email" className="my-3 mb-3">
          ...
          <Form.Group controlId="password" className="my-3 mb-3">
          ...
          <Form.Group controlId="confirmPassword" className="my-3 mb-4">
            <Form.Label className="fw-bold" style={{ fontSize: "0.9rem" }}>Confirm Password</Form.Label>
            <Form.Control
              type="password"
